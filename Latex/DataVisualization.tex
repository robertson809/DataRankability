...
\begin{tikzpicture}[scale=0.75]
	...
	\draw[lblue,->,thick](b) to [out=225,in=60,looseness=0](v);
	...
	\draw[lblue,->,thick](v) to [out=135,in=330,looseness=0](w);
	...
	\draw[gray,->,thick](v) to [out=75,in=255,looseness=0](s);
	% Pitsburgh
	% Temple
	\draw[gray,->,thick](t) to [out=330,in=120,looseness=0](p);
	% West Virginia
	\draw[gray,->,thick](w) to [out=270,in=90,looseness=0](t);
	\draw[gray,->,thick](w) to [out=45,in=225,looseness=0](r);
	\draw[lblue,->,thick](w) to [out=345,in=150,looseness=0](b);	\draw[gray,->,thick](w) to [out=315,in=105,looseness=0](p);
	% Rutgers
	\draw[gray,->,thick](r) to [out=270,in=90,looseness=0](p);
	\draw[gray,->,thick](r) to [out=255,in=75,looseness=0](t);
\end{tikzpicture}
\end{minipage}\hfill
\begin{minipage}{0.45\textwidth}
\centering
...
\begin{tikzpicture}[scale=0.75]
	...
	% Miami Florida
	\draw[lblue,->,thick](m) to [out=315,in=135,looseness=0](s);
	\draw[gray,->,thick](m) to [out=300,in=105,looseness=0](b);
	\draw[gray,->,thick](m) to [out=240,in=75,looseness=0](p);
	\draw[gray,->,thick](m) to [out=225,in=30,looseness=0](t);
	\draw[gray,->,thick](m) to [out=205,in=15,looseness=0](w);
	...
	\draw[gray,->,thick](s) to [out=180,in=0,looseness=0](w);
	\draw[gray,->,thick](s) to [out=150,in=345,looseness=0](r);
	\draw[lblue,->,thick](s) to [out=255,in=75,looseness=0](v);
	% Boston College
	\draw[gray,->,thick](b) to [out=180,in=0,looseness=0](t);
	\draw[gray,->,thick](b) to [out=120,in=330,looseness=0](r);
	% Virginia Tech
	...
	\draw[gray,->,thick](v) to [out=105,in=315,looseness=0](r);
	\draw[lblue,->,thick](v) to [out=90,in=270,looseness=0](m);
	\draw[gray,->,thick](v) to [out=180,in=0,looseness=0](p);
	% Pitsburgh
	\draw[gray,->,thick](p) to [out=45,in=195,looseness=0](b);
	...
	\draw[gray,->,thick](w) to [out=270,in=90,looseness=0](t);
	\draw[gray,->,thick](w) to [out=45,in=225,looseness=0](r);
	\draw[gray,->,thick](w) to [out=345,in=150,looseness=0](b);	\draw[gray,->,thick](w) to [out=315,in=105,looseness=0](p);
	% Rutgers
	\draw[gray,->,thick](r) to [out=255,in=75,looseness=0](t);	
\end{tikzpicture}
\end{minipage}\hfill
...
\begin{tikzpicture}[scale=0.75]
	...
	\draw[gray,->,thick](m) to [out=180,in=0,looseness=0](r);
	% Syracuse
	\draw[gray,->,thick](s) to [out=135,in=315,looseness=0](m);
	\draw[gray,->,thick](s) to [out=270,in=90,looseness=0](b);
	\draw[gray,->,thick](s) to [out=240,in=60,looseness=0](p);
	\draw[gray,->,thick](s) to [out=225,in=15,looseness=0](t);
	\draw[gray,->,thick](s) to [out=180,in=0,looseness=0](w);
	...
	% Virginia Tech
	\draw[gray,->,thick](v) to [out=60,in=225,looseness=0](b);
	\draw[lblue,->,thick](v) to [out=75,in=255,looseness=0](s);
	\draw[gray,->,thick](v) to [out=150,in=345,looseness=0](t);
	\draw[gray,->,thick](v) to [out=105,in=315,looseness=0](r);
	\draw[lblue,->,thick](v) to [out=90,in=270,looseness=0](m);
	% Pitsburgh
	...
	\draw[gray,->,thick](p) to [out=90,in=270,looseness=0](r);
	\draw[gray,->,thick](p) to [out=75,in=240,looseness=0](m);
	\draw[gray,->,thick](p) to [out=105,in=315,looseness=0](w);
	% Temple
	\draw[gray,->,thick](t) to [out=330,in=120,looseness=0](p);
	\draw[gray,->,thick](t) to [out=0,in=180,looseness=0](b);
	\draw[gray,->,thick](t) to [out=75,in=255,looseness=0](r);	
	% West Virginia
	\draw[gray,->,thick](w) to [out=330,in=135,looseness=0](v);
	\draw[gray,->,thick](w) to [out=15,in=205,looseness=0](m);
	\draw[gray,->,thick](w) to [out=270,in=90,looseness=0](t);
	\draw[gray,->,thick](w) to [out=45,in=225,looseness=0](r);
	% Rutgers
...
\begin{tikzpicture}[scale=0.75]
	...
	% Temple
	\draw[gray,->,thick](t) to [out=330,in=120,looseness=0](p);
	\draw[gray,->,thick](t) to [out=345,in=150,looseness=0](v);
	% West Virginia
	\draw[gray,->,thick](w) to [out=0,in=180,looseness=0](s);
	\draw[gray,->,thick](w) to [out=270,in=90,looseness=0](t);
	\draw[gray,->,thick](w) to [out=45,in=225,looseness=0](r);
	\draw[gray,->,thick](w) to [out=345,in=150,looseness=0](b);
	\draw[gray,->,thick](w) to [out=315,in=105,looseness=0](p);
	% Rutgers
	\draw[gray,->,thick](r) to [out=270,in=90,looseness=0](p);
	\draw[gray,->,thick](r) to [out=255,in=75,looseness=0](t);	
...
\begin{tikzpicture}[scale=0.75]
	...
	\draw[gray,->,thick](s) to [out=180,in=0,looseness=0](w);
	% Boston College
	\draw[gray,->,thick](b) to [out=90,in=270,looseness=0](s);
	\draw[gray,->,thick](b) to [out=195,in=45,looseness=0](p);
	\draw[gray,->,thick](b) to [out=120,in=330,looseness=0](r);
	\draw[gray,->,thick](b) to [out=150,in=345,looseness=0](w);
	% Virginia Tech
	...
	\draw[gray,->,thick](w) to [out=315,in=105,looseness=0](p);
	% Rutgers
	\draw[gray,->,thick](r) to [out=345,in=150,looseness=0](s);
